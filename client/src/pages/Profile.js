...
function Profile() {
  ...
  function uploadAvatar() {
    console.log("Updating the users profile");
    API.changeUserAvatar({ formObject })
      .then((result) => {
        console.log(result);
      })
      .catch((err) => {
    ...
    <Jumbotron>
      <Figure>
        <Figure.Image
          ...
          roundedCircle
        />
        <Figure.Caption>From {profile.location}</Figure.Caption>
      ...
      <Form>
        ...
        <Row>
          <Col>
            <h5>
              Hello I'm {profile.first_name}, let me tell you a bit about
              myself.
            </h5>
            <Row>
              <Col>
